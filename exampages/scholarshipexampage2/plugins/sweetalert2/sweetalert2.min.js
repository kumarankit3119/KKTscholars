! function(e, t) {
        ...
        return new Promise(function(r, a) {
            function l(e, t) {
                for (var n = 0; n < O.length; n++)
                    if (e += t, e === O.length ? e = 0 : -1 === e && (e = O.length - 1), O[e].offsetWidth || O[e].offsetHeight || O[e].getClientRects().length) return void O[e].focus()
            }
            ...
            function c(n) {
                ...
                if (-1 !== [9, 13, 32, 27].indexOf(i)) {
                    for (var r = o.target || o.srcElement, c = -1, s = 0; s < O.length; s++)
                        if (r === O[s]) {
                            c = s;
                            break
                        }
                    9 === i ? (o.shiftKey ? l(c, -1) : l(c, 1), T(o)) : 13 === i || 32 === i ? -1 === c && M(A, o) : 27 === i && e.allowEscapeKey === !0 && (t.closeModal(), a("esc"))
                }
            }
            e.timer && (o.timeout = setTimeout(function() {
                t.closeModal(), a("timer")
            }, e.timer));
            var u = function() {
                    switch (e.input) {
                        case "select":
            ...
            var f, B = function(n) {
                ...
                L = function(n) {
                    ...
                    switch (r.type) {
                        ...
                        case "mouseup":
                        case "focus":
                            e.buttonsStyling && (c ? l.style.backgroundColor = s(e.confirmButtonColor, -.1) : u && (l.style.backgroundColor = s(e.cancelButtonColor, -.1)));
                            break;
                        case "mouseout":
                        case "blur":
                            e.buttonsStyling && (c ? l.style.backgroundColor = e.confirmButtonColor : u && (l.style.backgroundColor = e.cancelButtonColor));
                            break;
                        case "mousedown":
                            e.buttonsStyling && (c ? l.style.backgroundColor = s(e.confirmButtonColor, -.2) : u && (l.style.backgroundColor = s(e.cancelButtonColor, -.2)));
                            break;
                        case "click":
                            if (c && d)
                                if (e.input) {
                                    var f = p();
                                    e.inputValidator ? (t.disableInput(), e.inputValidator(f, e.extraParams).then(function() {
                                        t.enableInput(), B(f)
                                    }, function(e) {
                                        t.enableInput(), e && t.showValidationError(e)
                                    })) : B(f)
                                } else B(!0);
                            else u && d && (t.closeModal(), a("cancel"))
                    }
                },
                q = o.querySelectorAll("button");
            for (f = 0; f < q.length; f++) q[f].onclick = L, q[f].onmouseover = L, q[f].onmouseout = L, q[f].onmousedown = L;
            d.previousDocumentClick = document.onclick, document.onclick = function(n) {
                var o = n || window.event,
                    r = o.target || o.srcElement;
                h(r, i.close) ? (t.closeModal(), a("close")) : r === m() && e.allowOutsideClick && (t.closeModal(), a("overlay"))
            };
            var A = v(),
                P = y(),
                O = [A, P].concat(Array.prototype.slice.call(o.querySelectorAll("button:not([class^=" + n + "]), input:not([type=hidden]), textarea, select")));
            for (f = 0; f < O.length; f++) O[f].onfocus = L, O[f].onblur = L;
            e.reverseButtons && A.parentNode.insertBefore(P, A), d.previousWindowKeyDown = window.onkeydown, window.onkeydown = c, e.buttonsStyling && (A.style.borderLeftColor = e.confirmButtonColor, A.style.borderRightColor = e.confirmButtonColor), t.showLoading = t.enableLoading = function() {
                g(A, "loading"), g(o, "loading"), P.disabled = !0
            }, t.hideLoading = t.disableLoading = function() {
                w(A, "loading"), w(o, "loading"), P.disabled = !1
            }, t.enableButtons = function() {
                A.disabled = !1, P.disabled = !1
            }, t.disableButtons = function() {
                A.disabled = !0, P.disabled = !0
            ...
            var N, V = ["input", "select", "radio", "checkbox", "textarea"];
            for (f = 0; f < V.length; f++) {
                var I = i[V[f]];
                for (N = k(o, I); N.attributes.length > 0;) N.removeAttribute(N.attributes[0].name);
                for (var j in e.inputAttributes) N.setAttribute(j, e.inputAttributes[j]);
                N.className = I, e.inputClass && g(N, e.inputClass), E(N)
            }
            var K;
            switch (e.input) {
                case "text":
                ...
                case "password":
                case "file":
                    N = k(o, i.input), N.value = e.inputValue, N.placeholder = e.inputPlaceholder, N.type = e.input, C(N);
                    break;
                case "select":
                    var W = k(o, i.select);
                    if (W.innerHTML = "", e.inputPlaceholder) {
                        var U = document.createElement("option");
                        U.innerHTML = e.inputPlaceholder, U.value = "", U.disabled = !0, U.selected = !0, W.appendChild(U)
                    }
                    K = function(t) {
                        for (var n in t) {
                            var o = document.createElement("option");
                            o.value = n, o.innerHTML = t[n], e.inputValue === n && (o.selected = !0), W.appendChild(o)
                        }
                        C(W), W.focus()
                    };
                    break;
                case "radio":
                    ...
                    break;
                case "checkbox":
                    var R = k(o, i.checkbox),
                        Z = o.querySelector("#" + i.checkbox);
                    Z.value = 1, Z.checked = Boolean(e.inputValue);
                    var $ = R.getElementsByTagName("span");
                    $.length && R.removeChild($[0]), $ = document.createElement("span"), $.innerHTML = e.inputPlaceholder, R.appendChild($), C(R);
                    break;
                case "textarea":
                    var _ = k(o, i.textarea);
                    _.value = e.inputValue, _.placeholder = e.inputPlaceholder, C(_);
                    break;
                case null:
                    break;
                default:
            ...
            "select" !== e.input && "radio" !== e.input || (e.inputOptions instanceof Promise ? (t.showLoading(), e.inputOptions.then(function(e) {
                t.hideLoading(), K(e)
            })) : "object" == typeof e.inputOptions ? K(e.inputOptions) : console.error("Unexpected type of inputOptions! Expected object or Promise, got " + e.inputOptions)), D(), H(e.animation), l(-1, 1)
        })
    }
    ...
    function t() {
        var n = arguments,
            o = f();
        return null === o && (t.init(), o = f()), h(o, "visible") && O(), e.apply(this, n)
    }
    var n = "swal2-",
        o = function(e) {
            var t = {};
        ...
        k = function(e, t) {
            for (var n = 0; n < e.childNodes.length; n++)
                if (e.childNodes[n].classList.contains(t)) return e.childNodes[n]
        },
        C = function(e) {
        ...
        L = function(e) {
            ...
            return e.style.left = "", e.style.display = "none", "-" + parseInt(t / 2, 10) + "px"
        },
        q = function(e, t) {
        ...
        V = function(e) {
            ...
            if (e.showCloseButton ? x(b) : S(b), n.className = i.modal, e.customClass && g(n, e.customClass), S(n.querySelectorAll("." + i.icon)), e.type) {
                var k = !1;
                for (var C in r)
                    if (e.type === C) {
                        k = !0;
                ...
                if (!k) return console.error("Unknown alert type: " + e.type), !1;
                ...
                switch (x(E), e.type) {
                    case "success":
                        ...
                        break;
                    case "error":
                        g(E, "animate-error-icon"), g(E.querySelector(".x-mark"), "animate-x-mark");
                        break;
                    case "warning":
                        g(E, "pulse-warning")
                }
        ...
        H = function(e) {
            var t = f();
            e ? (q(m(), 10), g(t, "show-swal2"), w(t, "hide-swal2")) : x(m()), x(t), d.previousActiveElement = document.activeElement, g(t, "visible")
        },
        D = function() {
            var e = f();
    ...
    return t.queue = function(e) {
            ...
            var e = f();
            w(e, "show-swal2"), g(e, "hide-swal2"), w(e, "visible");
            ...
            w(o, "pulse-warning"), O(), P && !h(e, "no-animation") ? e.addEventListener(P, function a() {
                e.removeEventListener(P, a), h(e, "hide-swal2") && (E(e), A(m(), 0))
            }) : (E(e), E(m()))
            ...
            N = c({}, a)
        }, t.version = "4.0.4", window.sweetAlert = window.swal = t,
        function() {
